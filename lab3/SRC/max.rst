   ...
   21CB                     401 _write_max:
                    ...
                    0000    408 	ar0 = 0x00
                    0001    409 	ar1 = 0x01
   21CB C0 15               410 	push	_bp
   21CD 85 81 15            411 	mov	_bp,sp
                            412 ;	SRC/max.c:52: unsigned char oldDPP = DPP;
                            413 ;	SRC/max.c:54: DPP     = MAXBASE;
                            414 ;	SRC/max.c:55: *regnum = val;
   21D0 AC 84               415 	mov	r4,_DPP
   21D2 75 84 08            416 	mov	_DPP,#0x08
   21D5 A8 15               417 	mov	r0,_bp
   21D7 18                  418 	dec	r0
   21D8 18                  419 	dec	r0
   21D9 18                  420 	dec	r0
   21DA E6                  421 	mov	a,@r0
   21DB F0                  422 	movx	@dptr,a
                            423 ;	SRC/max.c:56: DPP     = oldDPP;
   21DC 8C 84               424 	mov	_DPP,r4
   21DE D0 15               425 	pop	_bp
   21E0 22                  426 	ret
                            427 ;------------------------------------------------------------
   ...
   21E1 AC 84               442 	mov	r4,_DPP
   21E3 75 84 08            443 	mov	_DPP,#0x08
   21E6 E0                  444 	movx	a,@dptr
   21E7 FA                  445 	mov	r2,a
                            446 ;	SRC/max.c:79: DPP = oldDPP;
   21E8 8C 84               447 	mov	_DPP,r4
                            448 ;	SRC/max.c:81: return val;
   21EA 8A 82               449 	mov	dpl,r2
   21EC 22                  450 	ret
                            451 	.area CSEG    (CODE)
                            452 	.area CONST   (CODE)
                            453 	.area XINIT   (CODE)
