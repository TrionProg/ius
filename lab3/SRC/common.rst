   ...
   21ED                     402 _SetVector:
                    ...
                    0000    409 	ar0 = 0x00
                    0001    410 	ar1 = 0x01
   21ED C0 15               411 	push	_bp
   21EF 85 81 15            412 	mov	_bp,sp
                            413 ;	SRC/common.c:20: *Address = 0x02;
   21F2 AA 82               414 	mov	r2,dpl
   21F4 AB 83               415 	mov  r3,dph
   21F6 74 02               416 	mov	a,#0x02
   21F8 F0                  417 	movx	@dptr,a
                            418 ;	SRC/common.c:23: TmpVector = (unsigned char __xdata *) (Address + 1);
   21F9 0A                  419 	inc	r2
   21FA BA 00 01            420 	cjne	r2,#0x00,00103$
   21FD 0B                  421 	inc	r3
   21FE                     422 00103$:
                            423 ;	SRC/common.c:24: *TmpVector = (unsigned char) ((unsigned short)Vector >> 8);
   21FE E5 15               424 	mov	a,_bp
   2200 24 FB               425 	add	a,#0xfb
   2202 F8                  426 	mov	r0,a
   2203 86 04               427 	mov	ar4,@r0
   2205 08                  428 	inc	r0
   2206 86 05               429 	mov	ar5,@r0
   2208 8D 04               430 	mov	ar4,r5
   220A 8A 82               431 	mov	dpl,r2
   220C 8B 83               432 	mov	dph,r3
   220E EC                  433 	mov	a,r4
   220F F0                  434 	movx	@dptr,a
   2210 A3                  435 	inc	dptr
   2211 AA 82               436 	mov	r2,dpl
   2213 AB 83               437 	mov	r3,dph
                            438 ;	SRC/common.c:25: ++TmpVector;
                            439 ;	SRC/common.c:26: *TmpVector = (unsigned char) Vector;
   2215 E5 15               440 	mov	a,_bp
   2217 24 FB               441 	add	a,#0xfb
   2219 F8                  442 	mov	r0,a
   221A 86 04               443 	mov	ar4,@r0
   221C 8A 82               444 	mov	dpl,r2
   221E 8B 83               445 	mov	dph,r3
   2220 EC                  446 	mov	a,r4
   2221 F0                  447 	movx	@dptr,a
   2222 D0 15               448 	pop	_bp
   2224 22                  449 	ret
                            450 	.area CSEG    (CODE)
                            451 	.area CONST   (CODE)
   28B9                     452 _true:
