   ...
   2175                     406 _led:
                    ...
                    0000    413 	ar0 = 0x00
                    0001    414 	ar1 = 0x01
   2175 C0 15               415 	push	_bp
   2177 85 81 15            416 	mov	_bp,sp
                            417 ;	SRC/led.c:55: if( n > 7 ) return;
   217A E5 82               418 	mov	a,dpl
   217C FA                  419 	mov	r2,a
   217D 24 F8               420 	add	a,#0xff - 0x07
   217F 50 02               421 	jnc	00102$
   2181 80 32               422 	sjmp	00106$
   2183                     423 00102$:
                            424 ;	SRC/led.c:57: c = old_led;
   2183 AB 08               425 	mov	r3,_old_led
                            426 ;	SRC/led.c:59: mask <<= n;
   2185 8A F0               427 	mov	b,r2
   2187 05 F0               428 	inc	b
   2189 74 01               429 	mov	a,#0x01
   218B 80 02               430 	sjmp	00113$
   218D                     431 00111$:
   218D 25 E0               432 	add	a,acc
   218F                     433 00113$:
   218F D5 F0 FB            434 	djnz	b,00111$
   2192 FA                  435 	mov	r2,a
                            436 ;	SRC/led.c:61: if( on )
   2193 A8 15               437 	mov	r0,_bp
   2195 18                  438 	dec	r0
   2196 18                  439 	dec	r0
   2197 18                  440 	dec	r0
   2198 E6                  441 	mov	a,@r0
   2199 60 05               442 	jz	00104$
                            443 ;	SRC/led.c:62: c |= mask;
   219B EA                  444 	mov	a,r2
   219C 42 03               445 	orl	ar3,a
   219E 80 05               446 	sjmp	00105$
   21A0                     447 00104$:
                            448 ;	SRC/led.c:64: c &= ~mask;         
   21A0 EA                  449 	mov	a,r2
   21A1 F4                  450 	cpl	a
   21A2 FA                  451 	mov	r2,a
   21A3 52 03               452 	anl	ar3,a
   21A5                     453 00105$:
                            454 ;	SRC/led.c:66: write_max( SV, c );     
   21A5 C0 03               455 	push	ar3
   21A7 C0 03               456 	push	ar3
   21A9 90 00 07            457 	mov	dptr,#0x0007
   21AC 12 21 CB            458 	lcall	_write_max
   21AF 15 81               459 	dec	sp
   21B1 D0 03               460 	pop	ar3
                            461 ;	SRC/led.c:68: old_led = c;
   21B3 8B 08               462 	mov	_old_led,r3
   21B5                     463 00106$:
   21B5 D0 15               464 	pop	_bp
   21B7 22                  465 	ret
                            466 ;------------------------------------------------------------
                            ...
                            474 ;	-----------------------------------------
   21B8                     475 _leds:
   21B8 AA 82               476 	mov	r2,dpl
                            477 ;	SRC/led.c:89: write_max( SV, on );     
   21BA C0 02               478 	push	ar2
   21BC C0 02               479 	push	ar2
   21BE 90 00 07            480 	mov	dptr,#0x0007
   21C1 12 21 CB            481 	lcall	_write_max
   21C4 15 81               482 	dec	sp
   21C6 D0 02               483 	pop	ar2
                            484 ;	SRC/led.c:91: old_led = on;
   21C8 8A 08               485 	mov	_old_led,r2
   21CA 22                  486 	ret
                            487 	.area CSEG    (CODE)
                            488 	.area CONST   (CODE)
                            489 	.area XINIT   (CODE)
