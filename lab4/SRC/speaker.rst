   ...
   2AA2 7A E6               429 	mov	r2,#_T0_ISR
   2AA4 7B 2A               430 	mov	r3,#(_T0_ISR >> 8)
   2AA6 7C 80               431 	mov	r4,#0x80
   2AA8 C0 02               432 	push	ar2
   2AAA C0 03               433 	push	ar3
   2AAC C0 04               434 	push	ar4
   2AAE 90 20 0B            435 	mov	dptr,#0x200B
   2AB1 12 22 23            436 	lcall	_SetVector
   2AB4 15 81               437 	dec	sp
   2AB6 15 81               438 	dec	sp
   2AB8 15 81               439 	dec	sp
                            440 ;	SRC/speaker.c:12: TMOD|=0b00000010; //Timer0, внутренний генератор, 8 бит счетчик
   2ABA 43 89 02            441 	orl	_TMOD,#0x02
                            442 ;	SRC/speaker.c:13: ET0=1;       //включаем прерывание от таймера 0
   2ABD D2 A9               443 	setb	_ET0
                            444 ;	SRC/speaker.c:14: TH0=-250;
   2ABF 75 8C 06            445 	mov	_TH0,#0x06
   2AC2 22                  446 	ret
                            447 ;------------------------------------------------------------
                            ...
                            454 ;	-----------------------------------------
   2AC3                     455 _enable_speaker:
                            456 ;	SRC/speaker.c:18: speaker_on=false;
   2AC3 90 2B EC            457 	mov	dptr,#_false
   2AC6 E4                  458 	clr	a
   2AC7 93                  459 	movc	a,@a+dptr
   2AC8 F5 16               460 	mov	_speaker_on,a
                            461 ;	SRC/speaker.c:19: TL0=-250;
   2ACA 75 8A 06            462 	mov	_TL0,#0x06
                            463 ;	SRC/speaker.c:20: TR0=1;      //разрешаем счет таймера 0
   2ACD D2 8C               464 	setb	_TR0
   2ACF 22                  465 	ret
                            466 ;------------------------------------------------------------
                            ...
                            473 ;	-----------------------------------------
   2AD0                     474 _disable_speaker:
                            475 ;	SRC/speaker.c:24: TR0=0;      //запрещаем счет таймера 0
   2AD0 C2 8C               476 	clr	_TR0
                            477 ;	SRC/speaker.c:26: speaker_on=false;
   2AD2 90 2B EC            478 	mov	dptr,#_false
   2AD5 E4                  479 	clr	a
   2AD6 93                  480 	movc	a,@a+dptr
   2AD7 F5 16               481 	mov	_speaker_on,a
                            482 ;	SRC/speaker.c:27: write_max(ENA, 0b0100000);
   2AD9 74 20               483 	mov	a,#0x20
   2ADB C0 E0               484 	push	acc
   2ADD 90 00 04            485 	mov	dptr,#0x0004
   2AE0 12 22 01            486 	lcall	_write_max
   2AE3 15 81               487 	dec	sp
   2AE5 22                  488 	ret
                            489 ;------------------------------------------------------------
                            ...
                            496 ;	-----------------------------------------
   2AE6                     497 _T0_ISR:
   2AE6 C0 20               498 	push	bits
   2AE8 C0 E0               499 	push	acc
   2AEA C0 F0               500 	push	b
   2AEC C0 82               501 	push	dpl
   2AEE C0 83               502 	push	dph
   2AF0 C0 02               503 	push	(0+2)
   2AF2 C0 03               504 	push	(0+3)
   2AF4 C0 04               505 	push	(0+4)
   2AF6 C0 05               506 	push	(0+5)
   2AF8 C0 06               507 	push	(0+6)
   2AFA C0 07               508 	push	(0+7)
   2AFC C0 00               509 	push	(0+0)
   2AFE C0 01               510 	push	(0+1)
   2B00 C0 D0               511 	push	psw
   2B02 75 D0 00            512 	mov	psw,#0x00
                            513 ;	SRC/speaker.c:31: if( speaker_on ){
   2B05 E5 16               514 	mov	a,_speaker_on
   2B07 60 0E               515 	jz	00102$
                            516 ;	SRC/speaker.c:32: write_max(ENA, 0b0111100);
   2B09 74 3C               517 	mov	a,#0x3C
   2B0B C0 E0               518 	push	acc
   2B0D 90 00 04            519 	mov	dptr,#0x0004
   2B10 12 22 01            520 	lcall	_write_max
   2B13 15 81               521 	dec	sp
   2B15 80 0C               522 	sjmp	00103$
   2B17                     523 00102$:
                            524 ;	SRC/speaker.c:34: write_max(ENA, 0b0100000);
   2B17 74 20               525 	mov	a,#0x20
   2B19 C0 E0               526 	push	acc
   2B1B 90 00 04            527 	mov	dptr,#0x0004
   2B1E 12 22 01            528 	lcall	_write_max
   2B21 15 81               529 	dec	sp
   2B23                     530 00103$:
                            531 ;	SRC/speaker.c:37: speaker_on=!speaker_on;
   2B23 E5 16               532 	mov	a,_speaker_on
   2B25 B4 01 00            533 	cjne	a,#0x01,00108$
   2B28                     534 00108$:
   2B28 E4                  535 	clr	a
   2B29 33                  536 	rlc	a
   2B2A F5 16               537 	mov	_speaker_on,a
   2B2C D0 D0               538 	pop	psw
   2B2E D0 01               539 	pop	(0+1)
   2B30 D0 00               540 	pop	(0+0)
   2B32 D0 07               541 	pop	(0+7)
   2B34 D0 06               542 	pop	(0+6)
   2B36 D0 05               543 	pop	(0+5)
   2B38 D0 04               544 	pop	(0+4)
   2B3A D0 03               545 	pop	(0+3)
   2B3C D0 02               546 	pop	(0+2)
   2B3E D0 83               547 	pop	dph
   2B40 D0 82               548 	pop	dpl
   2B42 D0 F0               549 	pop	b
   2B44 D0 E0               550 	pop	acc
   2B46 D0 20               551 	pop	bits
   2B48 32                  552 	reti
                            553 	.area CSEG    (CODE)
                            554 	.area CONST   (CODE)
   2BEB                     555 _true:
