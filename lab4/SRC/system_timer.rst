   ...
   2167 F5 0A               411 	mov	(_cnt + 1),a
                            ...
                            428 ;	-----------------------------------------
   225B                     429 _initialize_system_timer:
                    0002    430 	ar2 = 0x02
                    0003    431 	ar3 = 0x03
                    0004    432 	ar4 = 0x04
                    0005    433 	ar5 = 0x05
   ...
   225B E4                  440 	clr	a
   225C F5 0B               441 	mov	_cur_ms,a
   225E F5 0C               442 	mov	(_cur_ms + 1),a
   2260 F5 0D               443 	mov	(_cur_ms + 2),a
   2262 F5 0E               444 	mov	(_cur_ms + 3),a
   2264 F5 09               445 	mov	_cnt,a
   2266 F5 0A               446 	mov	(_cnt + 1),a
                            447 ;	SRC/system_timer.c:20: SetVector( 0x202B, (void *)T2_ISR );
   2268 7A 18               448 	mov	r2,#_T2_ISR
   226A 7B 23               449 	mov	r3,#(_T2_ISR >> 8)
   226C 7C 80               450 	mov	r4,#0x80
   226E C0 02               451 	push	ar2
   2270 C0 03               452 	push	ar3
   2272 C0 04               453 	push	ar4
   2274 90 20 2B            454 	mov	dptr,#0x202B
   2277 12 22 23            455 	lcall	_SetVector
   227A 15 81               456 	dec	sp
   227C 15 81               457 	dec	sp
   227E 15 81               458 	dec	sp
                            459 ;	SRC/system_timer.c:23: TH2=(-1000)>>8;0;
   2280 75 CD FC            460 	mov	_TH2,#0xFC
                            461 ;	SRC/system_timer.c:24: TL2=(-1000)&0xFF;
   2283 75 CC 18            462 	mov	_TL2,#0x18
                            463 ;	SRC/system_timer.c:25: RCAP2H=(-1000)>>8;
   2286 75 CB FC            464 	mov	_RCAP2H,#0xFC
                            465 ;	SRC/system_timer.c:26: RCAP2L=(-1000)&0xFF;
   2289 75 CA 18            466 	mov	_RCAP2L,#0x18
                            467 ;	SRC/system_timer.c:28: ET2=1;       //включаем прерывание от таймера 2
   228C D2 AD               468 	setb	_ET2
                            469 ;	SRC/system_timer.c:29: TR2=1;      //разрешаем счет таймера 2
   228E D2 CA               470 	setb	_TR2
   2290 22                  471 	ret
                            472 ;------------------------------------------------------------
   ...
   2291 85 0B 82            482 	mov	dpl,_cur_ms
   2294 85 0C 83            483 	mov	dph,(_cur_ms + 1)
   2297 85 0D F0            484 	mov	b,(_cur_ms + 2)
   229A E5 0E               485 	mov	a,(_cur_ms + 3)
   229C 22                  486 	ret
                            487 ;------------------------------------------------------------
                            ...
                            495 ;	-----------------------------------------
   229D                     496 _get_ms_after:
   229D AA 82               497 	mov	r2,dpl
   229F AB 83               498 	mov	r3,dph
   22A1 AC F0               499 	mov	r4,b
   22A3 FD                  500 	mov	r5,a
                            501 ;	SRC/system_timer.c:37: return cur_ms-t0;
   22A4 E5 0B               502 	mov	a,_cur_ms
   22A6 C3                  503 	clr	c
   22A7 9A                  504 	subb	a,r2
   22A8 FA                  505 	mov	r2,a
   22A9 E5 0C               506 	mov	a,(_cur_ms + 1)
   22AB 9B                  507 	subb	a,r3
   22AC FB                  508 	mov	r3,a
   22AD E5 0D               509 	mov	a,(_cur_ms + 2)
   22AF 9C                  510 	subb	a,r4
   22B0 FC                  511 	mov	r4,a
   22B1 E5 0E               512 	mov	a,(_cur_ms + 3)
   22B3 9D                  513 	subb	a,r5
   22B4 8A 82               514 	mov	dpl,r2
   22B6 8B 83               515 	mov	dph,r3
   22B8 8C F0               516 	mov	b,r4
   22BA 22                  517 	ret
                            518 ;------------------------------------------------------------
                            ...
                            527 ;	-----------------------------------------
   22BB                     528 _delay_ms:
   22BB C0 18               529 	push	_bp
   22BD 85 81 18            530 	mov	_bp,sp
   22C0 C0 82               531 	push	dpl
   22C2 C0 83               532 	push	dph
   22C4 C0 F0               533 	push	b
   22C6 C0 E0               534 	push	acc
   22C8 E5 81               535 	mov	a,sp
   22CA 24 08               536 	add	a,#0x08
   22CC F5 81               537 	mov	sp,a
                            538 ;	SRC/system_timer.c:41: time now=get_ms();
   22CE 12 22 91            539 	lcall	_get_ms
   22D1 AA 82               540 	mov	r2,dpl
   22D3 AB 83               541 	mov	r3,dph
   22D5 AC F0               542 	mov	r4,b
   22D7 FD                  543 	mov	r5,a
   22D8 E5 18               544 	mov	a,_bp
   22DA 24 05               545 	add	a,#0x05
   22DC F8                  546 	mov	r0,a
   22DD A6 02               547 	mov	@r0,ar2
   22DF 08                  548 	inc	r0
   22E0 A6 03               549 	mov	@r0,ar3
   22E2 08                  550 	inc	r0
   22E3 A6 04               551 	mov	@r0,ar4
   22E5 08                  552 	inc	r0
   22E6 A6 05               553 	mov	@r0,ar5
                            554 ;	SRC/system_timer.c:43: while( get_ms_after(now)<t){}
   22E8                     555 00101$:
   22E8 E5 18               556 	mov	a,_bp
   22EA 24 05               557 	add	a,#0x05
   22EC F8                  558 	mov	r0,a
   22ED 86 82               559 	mov	dpl,@r0
   22EF 08                  560 	inc	r0
   22F0 86 83               561 	mov	dph,@r0
   22F2 08                  562 	inc	r0
   22F3 86 F0               563 	mov	b,@r0
   22F5 08                  564 	inc	r0
   22F6 E6                  565 	mov	a,@r0
   22F7 12 22 9D            566 	lcall	_get_ms_after
   22FA AC 82               567 	mov	r4,dpl
   22FC AD 83               568 	mov	r5,dph
   22FE AA F0               569 	mov	r2,b
   2300 FB                  570 	mov	r3,a
   2301 A8 18               571 	mov	r0,_bp
   2303 08                  572 	inc	r0
   2304 C3                  573 	clr	c
   2305 EC                  574 	mov	a,r4
   2306 96                  575 	subb	a,@r0
   2307 ED                  576 	mov	a,r5
   2308 08                  577 	inc	r0
   2309 96                  578 	subb	a,@r0
   230A EA                  579 	mov	a,r2
   230B 08                  580 	inc	r0
   230C 96                  581 	subb	a,@r0
   230D EB                  582 	mov	a,r3
   230E 08                  583 	inc	r0
   230F 96                  584 	subb	a,@r0
   2310 40 D6               585 	jc	00101$
   2312 85 18 81            586 	mov	sp,_bp
   2315 D0 18               587 	pop	_bp
   2317 22                  588 	ret
                            589 ;------------------------------------------------------------
                            ...
                            596 ;	-----------------------------------------
   2318                     597 _T2_ISR:
   2318 C0 20               598 	push	bits
   231A C0 E0               599 	push	acc
   231C C0 F0               600 	push	b
   231E C0 82               601 	push	dpl
   2320 C0 83               602 	push	dph
   2322 C0 02               603 	push	(0+2)
   2324 C0 03               604 	push	(0+3)
   2326 C0 04               605 	push	(0+4)
   2328 C0 05               606 	push	(0+5)
   232A C0 06               607 	push	(0+6)
   232C C0 07               608 	push	(0+7)
   232E C0 00               609 	push	(0+0)
   2330 C0 01               610 	push	(0+1)
   2332 C0 D0               611 	push	psw
   2334 75 D0 00            612 	mov	psw,#0x00
                            613 ;	SRC/system_timer.c:47: cur_ms++;
   2337 05 0B               614 	inc	_cur_ms
   2339 E4                  615 	clr	a
   233A B5 0B 0C            616 	cjne	a,_cur_ms,00103$
   233D 05 0C               617 	inc	(_cur_ms + 1)
   233F B5 0C 07            618 	cjne	a,(_cur_ms + 1),00103$
   2342 05 0D               619 	inc	(_cur_ms + 2)
   2344 B5 0D 02            620 	cjne	a,(_cur_ms + 2),00103$
   2347 05 0E               621 	inc	(_cur_ms + 3)
   2349                     622 00103$:
                            623 ;	SRC/system_timer.c:49: scan_keyboard_int();
   2349 12 29 99            624 	lcall	_scan_keyboard_int
   234C D0 D0               625 	pop	psw
   234E D0 01               626 	pop	(0+1)
   2350 D0 00               627 	pop	(0+0)
   2352 D0 07               628 	pop	(0+7)
   2354 D0 06               629 	pop	(0+6)
   2356 D0 05               630 	pop	(0+5)
   2358 D0 04               631 	pop	(0+4)
   235A D0 03               632 	pop	(0+3)
   235C D0 02               633 	pop	(0+2)
   235E D0 83               634 	pop	dph
   2360 D0 82               635 	pop	dpl
   2362 D0 F0               636 	pop	b
   2364 D0 E0               637 	pop	acc
   2366 D0 20               638 	pop	bits
   2368 32                  639 	reti
                            640 	.area CSEG    (CODE)
                            641 	.area CONST   (CODE)
   2B9B                     642 _true:
