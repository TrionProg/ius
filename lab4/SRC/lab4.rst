   ...
   2B49 12 22 5B            438 	lcall	_initialize_system_timer
                            439 ;	SRC/lab4.c:14: initialize_keyboard();
   2B4C 12 28 C3            440 	lcall	_initialize_keyboard
                            441 ;	SRC/lab4.c:15: initialize_uart(S9600);
   2B4F 75 82 FD            442 	mov	dpl,#0xFD
   2B52 12 23 69            443 	lcall	_initialize_uart
                            444 ;	SRC/lab4.c:16: initialize_handler();
   2B55 12 27 05            445 	lcall	_initialize_handler
                            446 ;	SRC/lab4.c:17: initialize_speaker();
   2B58 12 2A A2            447 	lcall	_initialize_speaker
                            448 ;	SRC/lab4.c:19: EA=1;
   2B5B D2 AF               449 	setb	_EA
                            450 ;	SRC/lab4.c:21: handler_loop();
   2B5D 02 27 90            451 	ljmp	_handler_loop
                            452 	.area CSEG    (CODE)
                            453 	.area CONST   (CODE)
   2BED                     454 _true:
   2BED FF                  455 	.db #0xFF
