   ...
   2369                     431 _initialize_uart:
                    ...
                    0000    438 	ar0 = 0x00
                    0001    439 	ar1 = 0x01
   2369 AA 82               440 	mov	r2,dpl
                            441 ;	SRC/uart.c:14: initialize_buffer(&buffer_in);
   236B 90 60 00            442 	mov	dptr,#_buffer_in
   236E 75 F0 00            443 	mov	b,#0x00
   2371 C0 02               444 	push	ar2
   2373 12 25 2A            445 	lcall	_initialize_buffer
                            446 ;	SRC/uart.c:15: initialize_buffer(&buffer_out);
   2376 90 60 43            447 	mov	dptr,#_buffer_out
   2379 75 F0 00            448 	mov	b,#0x00
   237C 12 25 2A            449 	lcall	_initialize_buffer
                            450 ;	SRC/uart.c:16: SetVector( 0x2023, (void *)UART_ISR );
   237F 7B A1               451 	mov	r3,#_UART_ISR
   2381 7C 24               452 	mov	r4,#(_UART_ISR >> 8)
   2383 7D 80               453 	mov	r5,#0x80
   2385 C0 03               454 	push	ar3
   2387 C0 04               455 	push	ar4
   2389 C0 05               456 	push	ar5
   238B 90 20 23            457 	mov	dptr,#0x2023
   238E 12 22 23            458 	lcall	_SetVector
   2391 15 81               459 	dec	sp
   2393 15 81               460 	dec	sp
   2395 15 81               461 	dec	sp
   2397 D0 02               462 	pop	ar2
                            463 ;	SRC/uart.c:18: TH1       =  speed; //Код скорости
   2399 8A 8D               464 	mov	_TH1,r2
                            465 ;	SRC/uart.c:19: TMOD     |=  0x20; //Таймер 1 будет работать в режиме autoreload
   239B 43 89 20            466 	orl	_TMOD,#0x20
                            467 ;	SRC/uart.c:20: TCON     |=  0x40; //Запуск таймера 1
   239E 43 88 40            468 	orl	_TCON,#0x40
                            469 ;	SRC/uart.c:21: SCON      =  0x50; //Настройки последовательного канала
   23A1 75 98 50            470 	mov	_SCON,#0x50
                            471 ;	SRC/uart.c:23: ES=1;
   23A4 D2 AC               472 	setb	_ES
   23A6 22                  473 	ret
                            474 ;------------------------------------------------------------
                            ...
                            482 ;	-----------------------------------------
   23A7                     483 _send_byte:
   23A7 AA 82               484 	mov	r2,dpl
                            485 ;	SRC/uart.c:27: ES=0;
   23A9 C2 AC               486 	clr	_ES
                            487 ;	SRC/uart.c:29: if( !sending_byte ){//начинаем процесс передачи
   23AB E5 10               488 	mov	a,_sending_byte
   23AD 70 0B               489 	jnz	00104$
                            490 ;	SRC/uart.c:30: sending_byte=true;
   23AF 90 2B 9F            491 	mov	dptr,#_true
   23B2 E4                  492 	clr	a
   23B3 93                  493 	movc	a,@a+dptr
   23B4 F5 10               494 	mov	_sending_byte,a
                            495 ;	SRC/uart.c:31: SBUF=dat;
   23B6 8A 99               496 	mov	_SBUF,r2
   23B8 80 1E               497 	sjmp	00105$
   23BA                     498 00104$:
                            499 ;	SRC/uart.c:32: }else if( !is_buffer_full(&buffer_out) ){
   23BA 90 60 43            500 	mov	dptr,#_buffer_out
   23BD 75 F0 00            501 	mov	b,#0x00
   23C0 C0 02               502 	push	ar2
   23C2 12 25 86            503 	lcall	_is_buffer_full
   23C5 E5 82               504 	mov	a,dpl
   23C7 D0 02               505 	pop	ar2
   23C9 70 0D               506 	jnz	00105$
                            507 ;	SRC/uart.c:33: push_byte_to_buffer(&buffer_out,dat);
   23CB C0 02               508 	push	ar2
   23CD 90 60 43            509 	mov	dptr,#_buffer_out
   23D0 75 F0 00            510 	mov	b,#0x00
   23D3 12 25 A5            511 	lcall	_push_byte_to_buffer
   23D6 15 81               512 	dec	sp
   23D8                     513 00105$:
                            514 ;	SRC/uart.c:36: ES=1;
   23D8 D2 AC               515 	setb	_ES
   23DA 22                  516 	ret
                            517 ;------------------------------------------------------------
                            ...
                            525 ;	-----------------------------------------
   23DB                     526 _send_string:
   23DB AA 82               527 	mov	r2,dpl
   23DD AB 83               528 	mov	r3,dph
   23DF AC F0               529 	mov	r4,b
                            530 ;	SRC/uart.c:40: ES=0;
   23E1 C2 AC               531 	clr	_ES
                            532 ;	SRC/uart.c:42: if( !sending_byte ){//начинаем процесс передачи
   23E3 E5 10               533 	mov	a,_sending_byte
   23E5 70 17               534 	jnz	00112$
                            535 ;	SRC/uart.c:43: sending_byte=true;
   23E7 90 2B 9F            536 	mov	dptr,#_true
   23EA E4                  537 	clr	a
   23EB 93                  538 	movc	a,@a+dptr
   23EC F5 10               539 	mov	_sending_byte,a
                            540 ;	SRC/uart.c:44: SBUF=*str;
   23EE 8A 82               541 	mov	dpl,r2
   23F0 8B 83               542 	mov	dph,r3
   23F2 8C F0               543 	mov	b,r4
   23F4 12 2B 79            544 	lcall	__gptrget
   23F7 F5 99               545 	mov	_SBUF,a
   23F9 A3                  546 	inc	dptr
   23FA AA 82               547 	mov	r2,dpl
   23FC AB 83               548 	mov	r3,dph
                            549 ;	SRC/uart.c:45: str++;
                            550 ;	SRC/uart.c:48: while( *str ) {
   23FE                     551 00112$:
   23FE                     552 00105$:
   23FE 8A 82               553 	mov	dpl,r2
   2400 8B 83               554 	mov	dph,r3
   2402 8C F0               555 	mov	b,r4
   2404 12 2B 79            556 	lcall	__gptrget
   2407 60 43               557 	jz	00107$
                            558 ;	SRC/uart.c:49: if( !is_buffer_full(&buffer_out) ){
   2409 90 60 43            559 	mov	dptr,#_buffer_out
   240C 75 F0 00            560 	mov	b,#0x00
   240F C0 02               561 	push	ar2
   2411 C0 03               562 	push	ar3
   2413 C0 04               563 	push	ar4
   2415 12 25 86            564 	lcall	_is_buffer_full
   2418 E5 82               565 	mov	a,dpl
   241A D0 04               566 	pop	ar4
   241C D0 03               567 	pop	ar3
   241E D0 02               568 	pop	ar2
   2420 70 DC               569 	jnz	00105$
                            570 ;	SRC/uart.c:50: push_byte_to_buffer(&buffer_out,*str);
   2422 8A 82               571 	mov	dpl,r2
   2424 8B 83               572 	mov	dph,r3
   2426 8C F0               573 	mov	b,r4
   2428 12 2B 79            574 	lcall	__gptrget
   242B FD                  575 	mov	r5,a
   242C A3                  576 	inc	dptr
   242D AA 82               577 	mov	r2,dpl
   242F AB 83               578 	mov	r3,dph
   2431 C0 02               579 	push	ar2
   2433 C0 03               580 	push	ar3
   2435 C0 04               581 	push	ar4
   2437 C0 05               582 	push	ar5
   2439 90 60 43            583 	mov	dptr,#_buffer_out
   243C 75 F0 00            584 	mov	b,#0x00
   243F 12 25 A5            585 	lcall	_push_byte_to_buffer
   2442 15 81               586 	dec	sp
   2444 D0 04               587 	pop	ar4
   2446 D0 03               588 	pop	ar3
   2448 D0 02               589 	pop	ar2
                            590 ;	SRC/uart.c:51: str++;
   244A 80 B2               591 	sjmp	00105$
   244C                     592 00107$:
                            593 ;	SRC/uart.c:55: ES=1;
   244C D2 AC               594 	setb	_ES
   244E 22                  595 	ret
                            596 ;------------------------------------------------------------
                            ...
                            605 ;	-----------------------------------------
   244F                     606 _read_byte:
   244F AA 82               607 	mov	r2,dpl
   2451 AB 83               608 	mov	r3,dph
   2453 AC F0               609 	mov	r4,b
                            610 ;	SRC/uart.c:61: ES=0;
   2455 C2 AC               611 	clr	_ES
                            612 ;	SRC/uart.c:63: is_data=!is_buffer_empty(&buffer_in);
   2457 90 60 00            613 	mov	dptr,#_buffer_in
   245A 75 F0 00            614 	mov	b,#0x00
   245D C0 02               615 	push	ar2
   245F C0 03               616 	push	ar3
   2461 C0 04               617 	push	ar4
   2463 12 25 67            618 	lcall	_is_buffer_empty
   2466 AD 82               619 	mov	r5,dpl
   2468 D0 04               620 	pop	ar4
   246A D0 03               621 	pop	ar3
   246C D0 02               622 	pop	ar2
   246E ED                  623 	mov	a,r5
   246F B4 01 00            624 	cjne	a,#0x01,00106$
   2472                     625 00106$:
   2472 E4                  626 	clr	a
   2473 33                  627 	rlc	a
                            628 ;	SRC/uart.c:65: if( is_data ){
   2474 FD                  629 	mov	r5,a
   2475 60 25               630 	jz	00102$
                            631 ;	SRC/uart.c:66: *dat=pop_byte_from_buffer(&buffer_in);
   2477 90 60 00            632 	mov	dptr,#_buffer_in
   247A 75 F0 00            633 	mov	b,#0x00
   247D C0 02               634 	push	ar2
   247F C0 03               635 	push	ar3
   2481 C0 04               636 	push	ar4
   2483 C0 05               637 	push	ar5
   2485 12 26 50            638 	lcall	_pop_byte_from_buffer
   2488 AE 82               639 	mov	r6,dpl
   248A D0 05               640 	pop	ar5
   248C D0 04               641 	pop	ar4
   248E D0 03               642 	pop	ar3
   2490 D0 02               643 	pop	ar2
   2492 8A 82               644 	mov	dpl,r2
   2494 8B 83               645 	mov	dph,r3
   2496 8C F0               646 	mov	b,r4
   2498 EE                  647 	mov	a,r6
   2499 12 2B 60            648 	lcall	__gptrput
   249C                     649 00102$:
                            650 ;	SRC/uart.c:69: ES=1;
   249C D2 AC               651 	setb	_ES
                            652 ;	SRC/uart.c:70: return is_data;
   249E 8D 82               653 	mov	dpl,r5
   24A0 22                  654 	ret
                            655 ;------------------------------------------------------------
                            ...
                            663 ;	-----------------------------------------
   24A1                     664 _UART_ISR:
   24A1 C0 20               665 	push	bits
   24A3 C0 E0               666 	push	acc
   24A5 C0 F0               667 	push	b
   24A7 C0 82               668 	push	dpl
   24A9 C0 83               669 	push	dph
   24AB C0 02               670 	push	(0+2)
   24AD C0 03               671 	push	(0+3)
   24AF C0 04               672 	push	(0+4)
   24B1 C0 05               673 	push	(0+5)
   24B3 C0 06               674 	push	(0+6)
   24B5 C0 07               675 	push	(0+7)
   24B7 C0 00               676 	push	(0+0)
   24B9 C0 01               677 	push	(0+1)
   24BB C0 D0               678 	push	psw
   24BD 75 D0 00            679 	mov	psw,#0x00
                            680 ;	SRC/uart.c:76: if( TI ){// Передача байта
   24C0 30 99 25            681 	jnb	_TI,00105$
                            682 ;	SRC/uart.c:77: if( is_buffer_empty(&buffer_out) ){
   24C3 90 60 43            683 	mov	dptr,#_buffer_out
   24C6 75 F0 00            684 	mov	b,#0x00
   24C9 12 25 67            685 	lcall	_is_buffer_empty
   24CC E5 82               686 	mov	a,dpl
   24CE 60 09               687 	jz	00102$
                            688 ;	SRC/uart.c:78: sending_byte=false;
   24D0 90 2B A0            689 	mov	dptr,#_false
   24D3 E4                  690 	clr	a
   24D4 93                  691 	movc	a,@a+dptr
   24D5 F5 10               692 	mov	_sending_byte,a
   24D7 80 0D               693 	sjmp	00103$
   24D9                     694 00102$:
                            695 ;	SRC/uart.c:80: dat=pop_byte_from_buffer(&buffer_out);
   24D9 90 60 43            696 	mov	dptr,#_buffer_out
   24DC 75 F0 00            697 	mov	b,#0x00
   24DF 12 26 50            698 	lcall	_pop_byte_from_buffer
   24E2 AA 82               699 	mov	r2,dpl
                            700 ;	SRC/uart.c:81: SBUF=dat;
   24E4 8A 99               701 	mov	_SBUF,r2
   24E6                     702 00103$:
                            703 ;	SRC/uart.c:84: TI=0;
   24E6 C2 99               704 	clr	_TI
   24E8                     705 00105$:
                            706 ;	SRC/uart.c:87: if( RI ){// Прием байта
                            707 ;	SRC/uart.c:88: RI=0;
   24E8 10 98 02            708 	jbc	_RI,00118$
   24EB 80 20               709 	sjmp	00110$
   24ED                     710 00118$:
                            711 ;	SRC/uart.c:89: dat=SBUF;
   24ED AA 99               712 	mov	r2,_SBUF
                            713 ;	SRC/uart.c:91: if( !is_buffer_full(&buffer_in) ){//Если полон, то теряем байт
   24EF 90 60 00            714 	mov	dptr,#_buffer_in
   24F2 75 F0 00            715 	mov	b,#0x00
   24F5 C0 02               716 	push	ar2
   24F7 12 25 86            717 	lcall	_is_buffer_full
   24FA E5 82               718 	mov	a,dpl
   24FC D0 02               719 	pop	ar2
   24FE 70 0D               720 	jnz	00110$
                            721 ;	SRC/uart.c:92: push_byte_to_buffer(&buffer_in,dat);
   2500 C0 02               722 	push	ar2
   2502 90 60 00            723 	mov	dptr,#_buffer_in
   2505 75 F0 00            724 	mov	b,#0x00
   2508 12 25 A5            725 	lcall	_push_byte_to_buffer
   250B 15 81               726 	dec	sp
   250D                     727 00110$:
   250D D0 D0               728 	pop	psw
   250F D0 01               729 	pop	(0+1)
   2511 D0 00               730 	pop	(0+0)
   2513 D0 07               731 	pop	(0+7)
   2515 D0 06               732 	pop	(0+6)
   2517 D0 05               733 	pop	(0+5)
   2519 D0 04               734 	pop	(0+4)
   251B D0 03               735 	pop	(0+3)
   251D D0 02               736 	pop	(0+2)
   251F D0 83               737 	pop	dph
   2521 D0 82               738 	pop	dpl
   2523 D0 F0               739 	pop	b
   2525 D0 E0               740 	pop	acc
   2527 D0 20               741 	pop	bits
   2529 32                  742 	reti
                            743 	.area CSEG    (CODE)
                            744 	.area CONST   (CODE)
   2B9F                     745 _true:
