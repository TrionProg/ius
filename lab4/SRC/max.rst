   ...
   2206 AC 84               415 	mov	r4,_DPP
   2208 75 84 08            416 	mov	_DPP,#0x08
   220B A8 18               417 	mov	r0,_bp
   220D 18                  418 	dec	r0
   220E 18                  419 	dec	r0
   220F 18                  420 	dec	r0
   2210 E6                  421 	mov	a,@r0
   2211 F0                  422 	movx	@dptr,a
                            423 ;	SRC/max.c:56: DPP     = oldDPP;
   2212 8C 84               424 	mov	_DPP,r4
   2214 D0 18               425 	pop	_bp
   2216 22                  426 	ret
                            427 ;------------------------------------------------------------
   ...
   2217 AC 84               442 	mov	r4,_DPP
   2219 75 84 08            443 	mov	_DPP,#0x08
   221C E0                  444 	movx	a,@dptr
   221D FA                  445 	mov	r2,a
                            446 ;	SRC/max.c:79: DPP = oldDPP;
   221E 8C 84               447 	mov	_DPP,r4
                            448 ;	SRC/max.c:81: return val;
   2220 8A 82               449 	mov	dpl,r2
   2222 22                  450 	ret
                            451 	.area CSEG    (CODE)
                            452 	.area CONST   (CODE)
                            453 	.area XINIT   (CODE)
